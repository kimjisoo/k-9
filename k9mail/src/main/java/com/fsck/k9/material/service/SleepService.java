...
public class SleepService extends CoreService {
    ...
    private static String ALARM_FIRED = "com.fsck.k9.material.service.SleepService.ALARM_FIRED";
    private static String LATCH_ID = "com.fsck.k9.material.service.SleepService.LATCH_ID_EXTRA";
