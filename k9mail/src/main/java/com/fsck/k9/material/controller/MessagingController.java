package com.fsck.k9.material.controller;
...
import com.fsck.k9.material.Account.DeletePolicy;
import com.fsck.k9.material.Account.Expunge;
import com.fsck.k9.material.AccountStats;
import com.fsck.k9.material.BuildConfig;
import com.fsck.k9.material.K9;
import com.fsck.k9.material.K9.Intents;
...
import com.fsck.k9.material.activity.setup.AccountSetupCheckSettings.CheckDirection;
import com.fsck.k9.material.cache.EmailProviderCache;
import com.fsck.k9.material.helper.Contacts;
import com.fsck.k9.material.mail.Address;
import com.fsck.k9.material.mail.AuthenticationFailedException;
import com.fsck.k9.material.mail.CertificateValidationException;
import com.fsck.k9.material.mail.FetchProfile;
import com.fsck.k9.material.mail.FetchProfile.Item;
import com.fsck.k9.material.mail.Flag;
import com.fsck.k9.material.mail.Folder;
import com.fsck.k9.material.mail.Folder.FolderType;
import com.fsck.k9.material.mail.Message;
import com.fsck.k9.material.mail.Message.RecipientType;
import com.fsck.k9.material.mail.MessageRetrievalListener;
import com.fsck.k9.material.mail.MessagingException;
import com.fsck.k9.material.mail.Part;
import com.fsck.k9.material.mail.PushReceiver;
import com.fsck.k9.material.mail.Pusher;
import com.fsck.k9.material.mail.Store;
import com.fsck.k9.material.mail.Transport;
import com.fsck.k9.material.mail.internet.MessageExtractor;
import com.fsck.k9.material.mail.internet.MimeMessage;
import com.fsck.k9.material.mail.internet.MimeMessageHelper;
import com.fsck.k9.material.mail.internet.MimeUtility;
import com.fsck.k9.material.mail.internet.TextBody;
import com.fsck.k9.material.mail.power.TracingPowerManager;
import com.fsck.k9.material.mail.power.TracingPowerManager.TracingWakeLock;
import com.fsck.k9.material.mail.store.pop3.Pop3Store;
import com.fsck.k9.material.mailstore.LocalFolder;
import com.fsck.k9.material.mailstore.LocalFolder.MoreMessages;
import com.fsck.k9.material.mailstore.LocalMessage;
import com.fsck.k9.material.mailstore.LocalStore;
import com.fsck.k9.material.mailstore.LocalStore.PendingCommand;
import com.fsck.k9.material.mailstore.MessageRemovalListener;
import com.fsck.k9.material.mailstore.UnavailableStorageException;
import com.fsck.k9.material.notification.NotificationController;
import com.fsck.k9.material.provider.EmailProvider;
import com.fsck.k9.material.provider.EmailProvider.StatsColumns;
import com.fsck.k9.material.search.ConditionsTreeNode;
import com.fsck.k9.material.search.LocalSearch;
import com.fsck.k9.material.search.SearchAccount;
import com.fsck.k9.material.search.SearchSpecification;
import com.fsck.k9.material.search.SqlQueryBuilder;
...
public class MessagingController {
    ...
    private static final String PENDING_COMMAND_MOVE_OR_COPY = "com.fsck.k9.material.MessagingController.moveOrCopy";
    private static final String PENDING_COMMAND_MOVE_OR_COPY_BULK = "com.fsck.k9.material.MessagingController.moveOrCopyBulk";
    private static final String PENDING_COMMAND_MOVE_OR_COPY_BULK_NEW = "com.fsck.k9.material.MessagingController.moveOrCopyBulkNew";
    private static final String PENDING_COMMAND_EMPTY_TRASH = "com.fsck.k9.material.MessagingController.emptyTrash";
    private static final String PENDING_COMMAND_SET_FLAG_BULK = "com.fsck.k9.material.MessagingController.setFlagBulk";
    private static final String PENDING_COMMAND_SET_FLAG = "com.fsck.k9.material.MessagingController.setFlag";
    private static final String PENDING_COMMAND_APPEND = "com.fsck.k9.material.MessagingController.append";
    private static final String PENDING_COMMAND_MARK_ALL_AS_READ = "com.fsck.k9.material.MessagingController.markAllAsRead";
    private static final String PENDING_COMMAND_EXPUNGE = "com.fsck.k9.material.MessagingController.expunge";
